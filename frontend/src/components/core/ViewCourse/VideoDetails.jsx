...
const VideoDetails = () => {
  ...
  const courseSectionData = useViewCourseStore(
  (state) => state.courseSectionData
);

const courseEntireData = useViewCourseStore(
  (state) => state.courseEntireData
);

const completedLectures = useViewCourseStore(
  ...
  const handleLectureCompletion = async () => {
    ...
    if (res) {
      updateCompletedLectures(subSectionId)
    }
    setLoading(false)
  }
