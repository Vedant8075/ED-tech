...
export async function resetPassword(newPassword, confirmPassword, token, navigate) {
  const toastId = toast.loading("Loading...")
  useAuthStore.getState().setLoading(true)
  try {
